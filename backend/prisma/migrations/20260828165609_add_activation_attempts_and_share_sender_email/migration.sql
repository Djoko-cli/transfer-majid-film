...
INSERT INTO "new_User" ("activationToken", "activationTokenExpiresAt", "canCreatePermanentShares", "createdAt", "email", "id", "isActivated", "isAdmin", "ldapDN", "password", "shareSizeLimit", "storageQuotaLimit", "totpEnabled", "totpSecret", "totpVerified", "updatedAt", "username") SELECT "activationToken", "activationTokenExpiresAt", "canCreatePermanentShares", "createdAt", "email", "id", "isActivated", "isAdmin", "ldapDN", "password", "shareSizeLimit", "storageQuotaLimit", "totpEnabled", "totpSecret", "totpVerified", "updatedAt", "username" FROM "User";
DROP TABLE "User";
