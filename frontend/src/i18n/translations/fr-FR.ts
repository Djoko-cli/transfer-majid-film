export default {
  ...
  "account.card.avatar.description":
    "Elle remplace l'icône de votre compte. Elle n'est visible que par vous. 5 Mio au maximum.",
  ...
  "account.card.avatar.too-large": "Cette image dépasse 5 Mio.",
  ...
  "share.collection.identity.not-you": "Ce n'est pas vous ?",
  ...
  "share.downloads.table.ip": "Adresse IP",
