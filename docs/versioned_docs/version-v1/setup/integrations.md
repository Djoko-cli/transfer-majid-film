...
2. Docker will wait for ClamAV to start before starting Transfer. This may take a minute or two.
3. The Transfer logs should now log "ClamAV is active"
