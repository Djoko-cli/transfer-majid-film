...
Add the following CORS configuration policy to your S3 bucket (replace `https://your-transfer-domain.com` with the actual URL and port you use to access your app):
...
[
  {
    ...
    "AllowedOrigins": ["https://your-transfer-domain.com"],
    "ExposeHeaders": ["ETag"],
    "MaxAgeSeconds": 3000
  }
]
...
### Key Rules
- **`AllowedOrigins`**: Must match the exact URL (scheme, domain, and port) you use to access Transfer in your browser (e.g., `http://100.116.239.35:3001` or `https://share.example.com`).
